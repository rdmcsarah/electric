            ...
            <nav className="pointer-events-auto flex flex-col gap-[1rem]">
                ...
                <a href="#about" className="group relative flex items-center gap-[1.8rem]">
                    ...
                    <div className="relative w-[2.2rem] h-[2.2rem] flex items-center justify-center">
                        <div className="absolute w-full h-full border border-gray-400/40 rounded-full"></div>
                        <div className="w-[0.5rem] h-[0.5rem] bg-gray-400 rounded-full transition-all duration-300 group-hover:translate-x-[0.25rem] group-hover:translate-y-[-0.15rem]"></div>
                    </div>
                    <span className="font-mono text-gray-400 text-[1.7rem] group-hover:translate-x-2 transition-transform duration-300">
                        About us
                    </span>
                </a>
                ...
                <a href="#faq" className="group relative flex items-center gap-[1.8rem]">
                    ...
                    <span className="font-mono text-[1.7rem] group-hover:translate-x-2 transition-transform duration-300 text-gray-400 ">
                        FAQ
                    </span>
                </a>
            </nav>
