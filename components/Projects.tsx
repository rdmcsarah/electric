...
export default function Projects() {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            particle.className = "absolute rounded-full bg-gradient-to-r from-white/30 to-gray-400/30";
        ...
        <div className="w-full min-h-screen bg-black text-white perspective-1000 overflow-hidden">
            ...
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        borderRadius: "50%",
                        background:
                            "radial-gradient(circle at center, transparent 30%, rgba(255, 255, 255, 0.1) 70%, rgba(255, 255, 255, 0.05) 100%)",
                    }}
                />
                ...
                <div className="absolute inset-0 overflow-hidden">
                    ...
                    <div className="absolute inset-0 grid grid-cols-4 grid-rows-3 opacity-40">
                        {Array.from({ length: 4 * 3 }).map((_, i) => {
                            ...
                            const centerX = 1.5; // center for fewer columns
                            const centerY = 1;   // center for fewer rows
                            const dx = col - centerX;
                            const dy = row - centerY;
                            ...
                            const theta = (col / 4) * Math.PI * 2;
                            const phi = (row / 3) * Math.PI;
                            const radius = 80;
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        ...
                                        borderRadius: "2px",
                                        boxShadow: `
            0 0 10px rgba(255, 255, 255, ${0.3 - normalizedDistance * 0.2}),
            inset 0 0 5px rgba(255, 255, 255, 0.1),
          ...
          `,
            ...
            radial-gradient(
              circle at center,
              transparent 20%,
              rgba(255, 255, 255, ${0.1 - normalizedDistance * 0.05}) 50%,
                        ...
                        <div className="max-w-6xl mx-auto">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                ...
                                <div className="relative h-[500px] flex items-center justify-center">
                                    <div className="absolute inset-0 bg-gradient-to-br from-black to-white rounded-full blur-3xl opacity-30"></div>
                                    ...
                                    >
                                        {/* Main Ball */}
                                        <div
                                            className="absolute inset-0 rounded-full bg-gradient-to-br from-white via-gray-300 to-gray-400"
                                            style={{
                                                transformStyle: "preserve-3d",
                                                boxShadow: `
                                        ...
                                        {/* Orbiting rings */}
                                        <div
                                            className="absolute inset-[-50px] rounded-full border border-white/30"
                                            style={{
                                        ...
                                        ></div>
                                        <div
                                            className="absolute inset-[-80px] rounded-full border border-white/20"
                                            style={{
                                        ...
                                        ></div>
                                        <div
                                            className="absolute inset-[-110px] rounded-full border border-white/10"
                                            style={{
                                        ...
                                        {[1, 2, 3, 4].map((i) => (
                                            <div
                                                key={i}
                                                className="absolute w-8 h-8 rounded-full bg-gradient-to-r from-white to-gray-400"
                                                style={{
